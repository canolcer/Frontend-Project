...
function handleApproveNewRequests(usernameTaken, roleTaken, idTaken, passwordTaken) {
  const userName = usernameTaken
    const role = roleTaken
    const id = idTaken
    const password = passwordTaken
...
function Table2() {
  ...
  const handleApprove = () => {
    ...
    handleApproveNewRequests(username, role, id, password);
