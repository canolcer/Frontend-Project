...
function Sidebar() {
  ...
  const handleManageCourseClick = () => {
    setShowManageCourse(prevState => !prevState);
  };
    ...
    <div className="sidebar">
      <ul>
        <li>
          ...
          <Link to="/" className="sidebar-button">Anasayfa</Link>
        </li>
        <li>
          <Link to="/user-list" className="sidebar-button" onClick={handleUserListClick}>User List</Link>
        </li>
        <li>
          <Link to="/manage-course" className="sidebar-button" onClick={handleManageCourseClick}>Manage Course</Link>
        </li>
        <li>
          <Link to="/" className="sidebar-button">Assign Account Types</Link>
        </li>
        <li>
          <Link to="/" className="sidebar-button">Manage Members</Link>
        </li>
        <li>
          <Link to="/" className="sidebar-button">Manage Question</Link>
        </li>
      </ul>
